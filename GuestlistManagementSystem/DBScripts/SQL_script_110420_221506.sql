...
alter table "APP"."GUESTLIST"  ADD COLUMN  "EVENT_OID"  integer;
alter table "APP"."GUESTLIST"   add constraint FK_EVENT foreign key ("EVENT_OID") references "APP"."EVENT" ("OID");


-- Guestlist_Invitation  [rel5]
alter table "APP"."INVITATION"  ADD COLUMN  "GUESTLIST_OID"  integer;
alter table "APP"."INVITATION"   add constraint FK_GUESTLIST foreign key ("GUESTLIST_OID") references "APP"."GUESTLIST" ("OID");


-- PermanentGuestlist_PermanentInvitation  [rel7]
alter table "APP"."PERMANENTINVITATION"  ADD COLUMN  "PERMANENTGUESTLIST_OID"  integer;
alter table "APP"."PERMANENTINVITATION"   add constraint FK_PERMANENTGUESTLIST foreign key ("PERMANENTGUESTLIST_OID") references "APP"."PERMANENTGUESTLIST" ("OID");


-- Event_User  [rel8]
alter table "APP"."EVENT"  ADD COLUMN  "USER_OID"  integer;
alter table "APP"."EVENT"   add constraint FK_USER_2 foreign key ("USER_OID") references "APP"."USER" ("OID");


-- PermanentGuestlist_User  [rel9]
alter table "APP"."PERMANENTGUESTLIST"  ADD COLUMN  "USER_OID"  integer;
alter table "APP"."PERMANENTGUESTLIST"   add constraint FK_USER_3 foreign key ("USER_OID") references "APP"."USER" ("OID");
