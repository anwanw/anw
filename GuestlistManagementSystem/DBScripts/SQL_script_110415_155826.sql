...
-- Event_Account  [rel3]
alter table "APP"."EVENT"  ADD COLUMN  "ACCOUNT_OID"  integer;
alter table "APP"."EVENT"   add constraint FK_ACCOUNT_2 foreign key ("ACCOUNT_OID") references "APP"."ACCOUNT" ("OID");
...
-- Account_PermanentGuestlist  [rel6]
alter table "APP"."ACCOUNT"  ADD COLUMN  "PERMANENTGUESTLIST_OID"  integer;
alter table "APP"."ACCOUNT"   add constraint FK_PERMANENTGUESTLIST foreign key ("PERMANENTGUESTLIST_OID") references "APP"."PERMANENTGUESTLIST" ("OID");
